...
<div class="container-fluid position-fixed bg-white shadow" id="navbar" height="80">
            ...
            <div class="col-lg-9">
                ...
                <a href="index.html" class="navbar-brand d-block d-lg-none">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        @if (Route::has('login'))
                            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block mr-5" >
                                @auth
                                @else
    ...
    <div class="container-fluid py-5 ">
        <div class="container py-5">
            <div class="row pt-5">
                <h1>Sudut pandang hukum Tindakan Pidana Korupsi</h1>
                <div class="col-lg-7 mt-4 mt-lg-0">
                    <p>1. Melawan hukum, memperkaya diri orang/badan lain yang merugikan keuangan/perekonomian Negara (Pasal 2)</p>
                    <p>2. Menyalahgunakan kewenangan karena jabatan/kedudukan yang dapat merugikan keuangan/kedudukan yang dapat merugikan keuangan/perekonomian Negara (Pasal 3)</p>
                    <P>3. Penyuapan (Pasal5, Pasal 6, dan Pasal 11)</P>
                    <P>4. Penggelapan dalam Jabatan (Pasal 8, Pasal 9, dan Pasal 10)</P>
                    <P>5. Pemerasan dalam Jabatan (Pasal 12)</P>
                    <P>6. Berkaitan dengan Pemborongan proyek pengadaan barang/jasa pemerintah (Pasal 7)</P>
                    <P>7. Gratifikasi (Pasal 12B dan Pasal 12C)</P>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row pt-5">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="d-flex flex-column justify-content-start">
                    ...
                    <a class="text-white mb-2" href=""><i class="fa fa-angle-right mr-2"></i>Tentang</a>
