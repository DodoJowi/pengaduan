<div class="c-sidebar c-sidebar-secondary c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
    <div class="c-sidebar-brand d-md-down-none">
    <img src="{{ ('img/logo.png ') }}" width="65"  class="c-sidebar-brand-full" alt="Brand Logo">
    <img src="{{ ('img/logo.png ') }}" width="65" height="46" class="c-sidebar-brand-minimized" alt="Brand Logo">
    </div>
